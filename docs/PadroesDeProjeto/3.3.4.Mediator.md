...
[Clique aqui para visualizar o código do Mediator](https://github.com/UnBArqDsw2026-1-Turma01/2026.1-T01-G02_ConhecendoRequisitos_Entrega_03/tree/main/gofs/comportamentais/mediator)
...
- Yan: Com o Mediator enxerguei com mais clareza como a centralização da orquestração de múltiplas entidades simplifica a manutenção e a evolução do sistema. Particularmente, percebi que o padrão é essencial quando temos uma máquina de estados complexa (como o fluxo de aprendizagem: conteúdo > módulo > quiz), pois evita que cada entidade precise conhecer todas as outras.
