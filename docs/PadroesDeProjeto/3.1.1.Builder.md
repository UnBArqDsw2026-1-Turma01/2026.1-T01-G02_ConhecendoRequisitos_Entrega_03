...
- Yan: Acredito que o padrão builder tem um papel extremamente importante na nossa aplicação, me possibilitou perceber coisas que não havia percebido antes, como a necessidade de modelar uma classe para a criação dos usuários, nesse contexto seria o `UsuarioDiretor`
...
| 1.3    | 14/05 | Percepção individual e remoção do vídeo por problemas técnicos | [Yan Aguiar](https://github.com/Yanmatheus0812)   | [Arthur Oliveira](https://github.com/arthurevang) | Revisado e aprovado |
